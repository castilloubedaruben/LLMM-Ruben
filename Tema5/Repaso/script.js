...
function quitarSeleccionATodos() {
  ...
  */
  const jugadores = document.getElementById("jugador")
  jugadores.forEach(jugador => { classList.remove("seleccionado")
...
function seleccionarJugador(jugador) {
  ...
  */
  listaJugadores.quitarSeleccionATodos()
  jugadorSeleccionado = getElementById("jugador seleccionado")
