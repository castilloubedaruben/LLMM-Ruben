...
function actualizarPanel(jugador) {
    ...
    */
    ...
    if (jugador!=null) {
        let nombreJugador = jugador.querySelector(".nombre").textContent
        let dorsal = jugador.dataset.dorsal
        let posicion = jugador.dataset.posicion
        let goles = jugador.dataset.goles

        detalleNombre.textContent=nombreJugador + " #" + dorsal
